...
struct RatesFluctuationView: View {
    ...
    @State private var isPresentedBMultiCurrencyFilter = false
    ...
    var body: some View {
        NavigationView {
            ...
            .toolbar {
                Button {
                    isPresentedBMultiCurrencyFilter.toggle()
                } label: {
                    Image(systemName: "slider.horizontal.3")
                }
                .fullScreenCover(isPresented: $isPresentedBMultiCurrencyFilter) {
